...
class SignUpView(SuccessMessageMixin, CreateView):
    ...
    success_message = "Теперь вы зарегистрированы, попробуйте войти!"
...
class UserUpdateView(LoginRequiredMixin, SuccessMessageMixin, FormView):
    ...
    success_message = "Теперь ваш профиль обновлен!"
...
class ProfileUpdateView(LoginRequiredMixin, SuccessMessageMixin, FormView):
    ...
    template_name = 'users/user_form.html'
    success_url = reverse_lazy('UserProfile')
    success_message = "Теперь ваша фотография обновлена."
    ...
    def form_valid(self, form):
        if 'image' in self.request.FILES:
            ...
            messages.add_message(self.request, messages.INFO,
                                 'Изображение вашего профиля не поменялось')
